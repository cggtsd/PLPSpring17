...
public class TypeCheckVisitorTestSandy {
    ...
    public void testFrameOpChain0() throws Exception {
        ...
        assertEquals(Scanner.Kind.KW_YLOC, frameOpChain1.getFirstToken().kind);
        ...
        assertEquals(Scanner.Kind.KW_SHOW, frameOpChain1.getFirstToken().kind);
    }
    ...
    public void testFrameOpChain1() throws Exception {
        ...
        assertEquals(Type.TypeName.FRAME, binaryChain0.getTypeName());
        assertEquals(Type.TypeName.INTEGER, frameOpChain1.getTypeName());
        assertEquals(Scanner.Kind.KW_XLOC, frameOpChain1.getFirstToken().kind);
        ...
        assertEquals(Type.TypeName.NONE, frameOpChain1.getTypeName());
        assertEquals(Scanner.Kind.KW_HIDE, frameOpChain1.getFirstToken().kind);
    }
    ...
    public void testFrameOpChain2() throws Exception {
        ...
        assertEquals(Scanner.Kind.KW_SHOW, frameOpChain1.getFirstToken().kind);
        assertEquals(Scanner.Kind.KW_XLOC, frameOpChain2.getFirstToken().kind);
        ...
        assertEquals(Scanner.Kind.KW_MOVE, frameOpChain2.getFirstToken().kind);
    ...
    public void testImageOpChain0() throws Exception {
        ...
        assertEquals(Scanner.Kind.KW_SCALE, imageOpChain0.getFirstToken().kind);
        assertEquals(Scanner.Kind.OP_WIDTH, imageOpChain1.getFirstToken().kind);
    }
    ...
    public void testImageOpChain1() throws Exception {
        ...
        assertEquals(Scanner.Kind.KW_SCALE, imageOpChain0.getFirstToken().kind);
        assertEquals(Scanner.Kind.OP_HEIGHT, imageOpChain1.getFirstToken().kind);
    }
